...
## Self-Verification via Screenshots (Claude Code)

### Purpose
Claude Code must use screenshots to visually verify its own work at every major
...
4. Analyze the screenshot for correctness against CLAUDE.md rules
...
- The visual output matches the expected behavior described in CLAUDE.md
